...
JNIEXPORT void JNICALL Java_org_opencv_samples_facedetect_DetectionBasedTracker_nativeSeedDetect
        (JNIEnv * jenv, jclass, jlong thiz, jlong frame, jlong dists)
{
    LOGD("Java_org_opencv_samples_facedetect_DetectionBasedTracker_nativeSeedDetect");
        ...
        for( int i = 0; i< contours.size(); i++ )
        {
            ...
            if ((area < 500) && (area >20)) {
                ...
                if (i < contours.size()-1)
                {
                    ...
                    putText(grayD, s.c_str() , Ncenter, FONT_HERSHEY_PLAIN, 1, Scalar(0,0,0),1);
